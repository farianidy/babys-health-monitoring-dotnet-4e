<%@ Page Title="BHM - (Dinkes) Balita" Language="C#" MasterPageFile="~/Dinkes.Master" AutoEventWireup="true"
    CodeBehind="Balita.aspx.cs" Inherits="Bhm.Web.DinasKes.Balita" %>
        ...
        <fieldset class="register">
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="BalitaRequired" runat="server" ControlToValidate="BalitaTb" 
                        CssClass="failureNotification" ErrorMessage="Data Balita harus di isi." ToolTip="Data Balita harus di isi." 
            ...
            <p>
                ...
                <asp:RequiredFieldValidator ID="AyahRequired" runat="server" ControlToValidate="Ayah" 
                        CssClass="failureNotification" ErrorMessage="Data Ayah harus di isi." ToolTip="Data Ayah harus di isi." 
                        ValidationGroup="BalitaValidationGroup">*</asp:RequiredFieldValidator>
            </p>
            <p>
                ...
                <asp:RequiredFieldValidator ID="IbuRequired" runat="server" ControlToValidate="Ibu" 
                        CssClass="failureNotification" ErrorMessage="Data Ibu harus di isi." ToolTip="Data Ibu harus di isi." 
                        ValidationGroup="BalitaValidationGroup">*</asp:RequiredFieldValidator>
            </p>

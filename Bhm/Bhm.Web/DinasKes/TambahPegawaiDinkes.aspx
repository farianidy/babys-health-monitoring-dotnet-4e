<%@ Page Title="" Language="C#" MasterPageFile="~/Dinkes.Master" AutoEventWireup="true" CodeBehind="TambahPegawaiDinkes.aspx.cs" Inherits="Bhm.Web.DinasKes.TambahPegawaiDinkes" %>
    ...
    <div class="accountInfo">
        <fieldset class="register">
            ...
            <p>
                ...
                <asp:TextBox ID="Instance" runat="server" CssClass="textEntry" Enabled="false" Text="Dinkes"></asp:TextBox>
            </p>
            <p>
            ...
            <p>
                <asp:Label ID="AdminLabel" runat="server">Administrator:</asp:Label>
